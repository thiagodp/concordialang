...
/**
  ...
  matcher.addMatch(
    new RegExp( ofPrefixes + "(now|current(?: |\\t)+time)", "gi" ),
    timeFromMatch( now() )
  );
  ...
  matcher.addMatch(
    new RegExp( ofPrefixes + "(last(?: |\\t)+hour|previous(?: |\\t)+hour)", "gi" ),
    timeFromMatch( now().minusHours( 1 ) )
  );

  matcher.addMatch(
    new RegExp( ofPrefixes + "(last(?: |\\t)+minute|previous(?: |\\t)+minute)", "gi" ),
    timeFromMatch( now().minusMinutes( 1 ) )
  );

  matcher.addMatch(
    new RegExp( ofPrefixes + "(last(?: |\\t)+second|previous(?: |\\t)+second)", "gi" ),
  ...
  matcher.addMatch(
    new RegExp( ofPrefixes + "(next(?: |\\t)+hour)", "gi" ),
    timeFromMatch( now().plusHours( 1 ) )
  );

  matcher.addMatch(
    new RegExp( ofPrefixes + "(next(?: |\\t)+minute)", "gi" ),
    timeFromMatch( now().plusMinutes( 1 ) )
  );

  matcher.addMatch(
    new RegExp( ofPrefixes + "(next(?: |\\t)+second)", "gi" ),
...
Bravey.Language.EN.DateTimeEntityRecognizer = function( entityName ) {
  ...
  matcher.addMatch(
    new RegExp( "current(?: |\\t)+date(?: |\\t)+and(?: |\\t)+time", "gi" ),
...
Bravey.Language.EN.DateEntityRecognizer = function(entityName) {
  ...
  matcher.addMatch( new RegExp( ofPrefixes + "(last(?: |\\t)+year)\\b", "gi" ),
    dateFromMatch( now().minusYears( 1 ) )
  );

  matcher.addMatch( new RegExp( ofPrefixes + "(last(?: |\\t)+semester)\\b", "gi" ),
    dateFromMatch( now().minusMonths( 6 ) )
  );

  matcher.addMatch( new RegExp( ofPrefixes + "(last(?: |\\t)+month)\\b", "gi" ),
    dateFromMatch( now().minusMonths( 1 ) )
  );

  matcher.addMatch( new RegExp( ofPrefixes + "(last(?: |\\t)+week)", "gi" ),
    dateFromMatch( now().minusDays( 7 ) )
  );

  matcher.addMatch( new RegExp( ofPrefixes + "(the(?: |\\t)+day(?: |\\t)+before(?: |\\t)+yesterday)", "gi" ),
  ...
  matcher.addMatch( new RegExp( ofPrefixes + "(today|current(?: |\\t)+date)", "gi" ),
    dateFromMatch( now() )
  );

  matcher.addMatch( new RegExp( ofPrefixes + "(tomorrow)", "gi" ),
    dateFromMatch( now().plusDays( 1 ) )
  );

  matcher.addMatch( new RegExp( ofPrefixes + "(the(?: |\\t)+day(?: |\\t)+after(?: |\\t)+tomorrow)", "gi" ),
    dateFromMatch( now().plusDays( 2 ) )
  );

  matcher.addMatch( new RegExp( ofPrefixes + "(next(?: |\\t)+week)", "gi" ),
    dateFromMatch( now().plusDays( 7 ) )
  );

  matcher.addMatch( new RegExp(ofPrefixes + "(next(?: |\\t)+month)", "gi" ),
    dateFromMatch( now().plusMonths( 1 ) )
  );

  matcher.addMatch( new RegExp(ofPrefixes + "(next(?: |\\t)+semester)", "gi" ),
    dateFromMatch( now().plusMonths( 6 ) )
  );

  matcher.addMatch( new RegExp(ofPrefixes + "(next(?: |\\t)+year)", "gi" ),
...
Bravey.Language.PT.TimeEntityRecognizer2 = function( entityName ) {
  ...
  matcher.addMatch(
    new RegExp( ofPrefixes + "(agora|hora(?: |\\t)+atual)", "gi" ),
    timeFromMatch( now() )
  );

  matcher.addMatch(
    new RegExp( ofPrefixes + "([úu]ltima(?: |\\t)+hora|hora(?: |\\t)+anterior)", "gi" ),
    timeFromMatch( now().minusHours( 1 ) )
  );

  matcher.addMatch(
    new RegExp( ofPrefixes + "([úu]ltimo(?: |\\t)+minuto|minuto(?: |\\t)+anterior)", "gi" ),
    timeFromMatch( now().minusMinutes( 1 ) )
  );

  matcher.addMatch(
    new RegExp( ofPrefixes + "([úu]ltimo(?: |\\t)+segundo|segundo(?: |\\t)+anterior)", "gi" ),
    timeFromMatch( now().minusSeconds( 1 ) )
  );

  matcher.addMatch(
    new RegExp( ofPrefixes + "(pr[óo]xima(?: |\\t)+hora|hora(?: |\\t)+seguinte)", "gi" ),
    timeFromMatch( now().plusHours( 1 ) )
  );

  matcher.addMatch(
    new RegExp( ofPrefixes + "(pr[óo]ximo(?: |\\t)+minuto|minuto(?: |\\t)+seguinte)", "gi" ),
    timeFromMatch( now().plusMinutes( 1 ) )
  );

  matcher.addMatch(
    new RegExp( ofPrefixes + "(pr[óo]ximo(?: |\\t)+segundo|segundo(?: |\\t)+seguinte)", "gi" ),
    timeFromMatch( now().plusSeconds( 1 ) )
  );
...
Bravey.Language.PT.DateTimeEntityRecognizer = function( entityName ) {
  ...
  matcher.addMatch(
    new RegExp( "data(?: |\\t)+e(?: |\\t)+hora(?: |\\t)+(atual|atuais)", "gi" ),
    function( match ) { return now(); }
  );
...
Bravey.Language.PT.DateEntityRecognizer = function(entityName) {
  ...
  matcher.addMatch (new RegExp( ofPrefixes + "(depois(?: |\\t)+de(?: |\\t)+amanh[ãa])", "gi" ),
    dateFromMatch( now().plusDays( 2 ) )
  );

  matcher.addMatch( new RegExp( ofPrefixes + "(semana(?: |\\t)+que(?: |\\t)+vem)", "gi" ),
    dateFromMatch( now().plusDays( 7 ) )
  );

  matcher.addMatch( new RegExp( ofPrefixes + "(m[êe]s(?: |\\t)+que(?: |\\t)+vem)", "gi" ),
    dateFromMatch( now().plusMonths( 1 ) )
  );

  matcher.addMatch( new RegExp( ofPrefixes + "(semestre(?: |\\t)+que(?: |\\t)+vem)", "gi" ),
    dateFromMatch( now().plusMonths( 6 ) )
  );

  matcher.addMatch( new RegExp( ofPrefixes + "(ano(?: |\\t)+que(?: |\\t)+vem)", "gi" ),
    dateFromMatch( now().plusYears( 1 ) )
  );
  ...
  matcher.addMatch( new RegExp( ofPrefixes + "(anteontem|antes(?: |\\t)+de(?: |\\t)+ontem)", "gi" ),
    dateFromMatch( now().minusDays( 2 ) )
  );

  matcher.addMatch( new RegExp( ofPrefixes + "(semana(?: |\\t)+passada)", "gi" ),
    dateFromMatch( now().minusDays( 7 ) )
  );

  matcher.addMatch( new RegExp( ofPrefixes + "(m[êe]s(?: |\\t)+passado)", "gi" ),
    dateFromMatch( now().minusMonths( 1 ) )
  );

  matcher.addMatch( new RegExp( ofPrefixes + "(semestre(?: |\\t)+passado)", "gi" ),
    dateFromMatch( now().minusMonths( 6 ) )
  );

  matcher.addMatch( new RegExp( ofPrefixes + "(ano(?: |\\t)+passado)", "gi" ),
    dateFromMatch( now().minusYears( 1 ) )
  );

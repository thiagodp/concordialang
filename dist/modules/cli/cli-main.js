...
import { joinDatabasePackageNames, makeLockFileName, makePackageInstallCommand, makePackageUninstallCommand, packageManagers, } from '../util/package-installation';
import { runCommand } from '../util/run-command';
import { parseArgs } from './args';
import { helpContent } from './cli-help';
import { UI } from './cli-ui';
import { hasSomePluginAction } from './CliOnlyOptions';
import { GuidedConfig } from './GuidedConfig';
// Prevent caching of this module so module.parent is always accurate
// delete require.cache[__filename];
// const parentDir = path.dirname(module.parent.filename);
export async function main(appPath, processPath) {
    ...
    if (hasSomePluginAction(options)) {
        ...
        const pluginManager = new PluginManager(options.packageManager, ui, pluginFinder, fileHandler);

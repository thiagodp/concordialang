...
describe('StepUtilTest', () => {
    ...
    it('moves a GIVEN with a precondition and updates an AND that follows it to become a GIVEN', () => {
        let steps = [
            ...
            { nodeType: NodeTypes_1.NodeTypes.STEP_GIVEN, values: ['d'], nlpResult: { entities: [{ entity: concordialang_types_1.Entities.STATE, value: 'some state' }] } },
    ...
    it('moves an AND with a precondition and updates an AND that follows it to become a GIVEN', () => {
        let steps = [
            ...
            { nodeType: NodeTypes_1.NodeTypes.STEP_AND, values: ['e'], nlpResult: { entities: [{ entity: concordialang_types_1.Entities.STATE, value: 'some state' }] } },
            { nodeType: NodeTypes_1.NodeTypes.STEP_AND, values: ['f'] },
            { nodeType: NodeTypes_1.NodeTypes.STEP_THEN, values: ['g'] },
            { nodeType: NodeTypes_1.NodeTypes.STEP_AND, values: ['h'] }
        ];
    ...
    it('moves after existing steps with preconditions', () => {
        let steps = [
            { nodeType: NodeTypes_1.NodeTypes.STEP_GIVEN, values: ['a'], nlpResult: { entities: [{ entity: concordialang_types_1.Entities.STATE, value: 'foo' }] } },
            { nodeType: NodeTypes_1.NodeTypes.STEP_WHEN, values: ['b'] },
            { nodeType: NodeTypes_1.NodeTypes.STEP_AND, values: ['c'] },
            { nodeType: NodeTypes_1.NodeTypes.STEP_AND, values: ['d'] },
            { nodeType: NodeTypes_1.NodeTypes.STEP_GIVEN, values: ['e'], nlpResult: { entities: [{ entity: concordialang_types_1.Entities.STATE, value: 'bar' }] } },
            { nodeType: NodeTypes_1.NodeTypes.STEP_AND, values: ['f'], nlpResult: { entities: [{ entity: concordialang_types_1.Entities.STATE, value: 'baz' }] } },

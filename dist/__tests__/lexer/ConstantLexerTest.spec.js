...
const ConstantLexer_1 = require("../../modules/lexer/ConstantLexer");
/**
 * @author Thiago Delgado Pinto
 */
describe('ConstantLexerTest', () => {
    let words = ['is'];
    let keyword = NodeTypes_1.NodeTypes.CONSTANT;
    let lexer = new ConstantLexer_1.ConstantLexer(words); // under test
...
//# sourceMappingURL=ConstantLexerTest.spec.js.map
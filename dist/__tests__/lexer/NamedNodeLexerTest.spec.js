...
const NamedNodeLexer_1 = require("../../modules/lexer/NamedNodeLexer");
/**
 * @author Thiago Delgado Pinto
 */
describe('NamedNodeLexerTest', () => {
    let keyword = 'feature';
    let wordInsensitive = 'FeAtURe';
    let word = 'feature';
    let words = [word];
    let lexer = new NamedNodeLexer_1.NamedNodeLexer(words, keyword); // under test
...
//# sourceMappingURL=NamedNodeLexerTest.spec.js.map
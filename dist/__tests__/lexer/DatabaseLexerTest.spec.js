...
const DatabaseLexer_1 = require("../../modules/lexer/DatabaseLexer");
/**
 * @author Thiago Delgado Pinto
 */
describe('DatabaseLexerTest', () => {
    ...
    let words = ['database'];
    let lexer = new DatabaseLexer_1.DatabaseLexer(words); // under test
    it('detects correctly', () => {
        ...
        let n = r.nodes[0];
        expect(n.nodeType).toBe(NodeTypes_1.NodeTypes.DATABASE);

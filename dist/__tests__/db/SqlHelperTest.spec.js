...
const SqlHelper_1 = require("../../modules/db/SqlHelper");
const ValueTypeDetector_1 = require("../../modules/util/ValueTypeDetector");
const alasql = require("alasql");
/**
 * @author Thiago Delgado Pinto
 */
describe('SqlHelperTest', () => {
    let helper = new SqlHelper_1.SqlHelper(); // under test
    ...
    it('generates columns correctly', () => {
        const sqlTypes = (new ValueTypeDetector_1.ValueTypeDetector()).detectAll(values[0])
            .map(vt => helper.convertToSQLType(vt));
        const sqlColumns = helper.generateSqlColumns(columns, sqlTypes);

...
export const CODECEPTJS_COMMANDS: CmdCfg[] = [
    ...
    // append
    { action: 'append', comp: CmdCmp.ONE_TARGET__ONE_VALUE, template: 'I.appendField({{{target}}}, {{{value}}});' },
    // attachFile
    ...
    // click
    { action: 'click', comp: CmdCmp.ONE_VALUE__ONE_TARGET, template: 'I.click({{{value}}}, {{{target}}});' },
    ...
    // doubleClick
    { action: 'doubleClick', comp: CmdCmp.ONE_VALUE__ONE_TARGET, template: 'I.doubleClick({{{value}}}, {{{target}}});' },
    ...
    // press
    { action: 'press', comp: CmdCmp.ONE_VALUE__OR_ARRAY, template: 'I.pressKey({{{value}}});' },
    ...
    { action: 'see', comp: CmdCmp.SAME_MODIFIER__SAME_OPTION__ONE_TARGET__ONE_VALUE, options: [ 'inside' ], template: 'I.see({{{value}}}, {{{target}}});' },
    // see + value + not + inside + target
    { action: 'see', comp: CmdCmp.SAME_MODIFIER__SAME_OPTION__ONE_TARGET__ONE_VALUE, options: [ 'inside' ], modifier: 'not', template: 'I.dontSee({{{value}}}, {{{target}}});' },
    // see + with
    { action: 'see', comp: CmdCmp.SAME_MODIFIER__SAME_OPTION__ONE_TARGET__ONE_VALUE, options: [ 'with' ], template: 'I.see({{{value}}}, {{{target}}});' },
    // see + with + not
    { action: 'see', comp: CmdCmp.SAME_MODIFIER__SAME_OPTION__ONE_TARGET__ONE_VALUE, options: [ 'with' ], modifier: 'not', template: 'I.dontSee({{{value}}}, {{{target}}});' },
    // see + field as option
    { action: 'see', comp: CmdCmp.SAME_MODIFIER__SAME_OPTION__ONE_TARGET__ONE_VALUE, options: [ 'field' ], template: 'I.seeInField({{{target}}}, {{{value}}});' },
    // see + field as option + not
    { action: 'see', comp: CmdCmp.SAME_MODIFIER__SAME_OPTION__ONE_TARGET__ONE_VALUE, options: [ 'field' ], modifier: 'not', template: 'I.dontSeeInField({{{target}}}, {{{value}}});' },
    // see + textbox as target type
    { action: 'see', comp: CmdCmp.SAME_MODIFIER__SAME_TARGET_TYPE__ONE_TARGET__ONE_VALUE, targetType: 'textbox', template: 'I.seeInField({{{target}}}, {{{value}}});' },
    // see + textbox as target type + not
    { action: 'see', comp: CmdCmp.SAME_MODIFIER__SAME_TARGET_TYPE__ONE_TARGET__ONE_VALUE, targetType: 'textbox', modifier: 'not', template: 'I.dontSeeInField({{{target}}}, {{{value}}});' },
    // see + textarea as target type
    { action: 'see', comp: CmdCmp.SAME_MODIFIER__SAME_TARGET_TYPE__ONE_TARGET__ONE_VALUE, targetType: 'textarea', template: 'I.seeInField({{{target}}}, {{{value}}});' },
    // see + textarea as target type + not
    { action: 'see', comp: CmdCmp.SAME_MODIFIER__SAME_TARGET_TYPE__ONE_TARGET__ONE_VALUE, targetType: 'textarea', modifier: 'not', template: 'I.dontSeeInField({{{target}}}, {{{value}}});' },
    // see + checkbox
    ...
    // see + cookie
    { action: 'see', comp: CmdCmp.SAME_MODIFIER__SAME_TARGET_TYPE__ONE_VALUE, targetType: 'cookie', template: 'I.seeCookie({{{value}}});' },
    { action: 'see', comp: CmdCmp.SAME_MODIFIER__SAME_OPTION__ONE_VALUE, options: [ 'cookie' ], template: 'I.seeCookie({{{value}}});' },
    // see + cookie + not
    { action: 'see', comp: CmdCmp.SAME_MODIFIER__SAME_TARGET_TYPE__ONE_VALUE, targetType: 'cookie', modifier: 'not', template: 'I.dontSeeCookie({{{value}}});' },
    { action: 'see', comp: CmdCmp.SAME_MODIFIER__SAME_OPTION__ONE_VALUE, options: [ 'cookie' ], modifier: 'not', template: 'I.dontSeeCookie({{{value}}});' },
    // see + title
    { action: 'see', comp: CmdCmp.SAME_MODIFIER__SAME_TARGET_TYPE__ONE_VALUE, targetType: 'title', template: 'I.seeInTitle({{{value}}});' },
    { action: 'see', comp: CmdCmp.SAME_MODIFIER__SAME_OPTION__ONE_VALUE, options: [ 'title' ], template: 'I.seeInTitle({{{value}}});' },
    // see + title + not
    { action: 'see', comp: CmdCmp.SAME_MODIFIER__SAME_TARGET_TYPE__ONE_VALUE, targetType: 'title', modifier: 'not', template: 'I.dontSeeInTitle({{{value}}});' },
    { action: 'see', comp: CmdCmp.SAME_MODIFIER__SAME_OPTION__ONE_VALUE, options: [ 'title' ], modifier: 'not', template: 'I.dontSeeInTitle({{{value}}});' },
    // see + url
    { action: 'see', comp: CmdCmp.SAME_MODIFIER__SAME_TARGET_TYPE__ONE_VALUE, targetType: 'url', template: 'I.seeInCurrentUrl({{{value}}});' },
    { action: 'see', comp: CmdCmp.SAME_MODIFIER__SAME_OPTION__ONE_VALUE, options: [ 'url' ], template: 'I.seeInCurrentUrl({{{value}}});' },
    // see + url + not
    { action: 'see', comp: CmdCmp.SAME_MODIFIER__SAME_TARGET_TYPE__ONE_VALUE, targetType: 'url', modifier: 'not', template: 'I.dontSeeInCurrentUrl({{{value}}});' },
    { action: 'see', comp: CmdCmp.SAME_MODIFIER__SAME_OPTION__ONE_VALUE, options: [ 'url' ], modifier: 'not', template: 'I.dontSeeInCurrentUrl({{{value}}});' },
    // see + target
    ...
    // see
    { action: 'see', comp: CmdCmp.SAME_MODIFIER__ONE_VALUE, template: 'I.see({{{value}}});' },
    // see + not
    { action: 'see', comp: CmdCmp.SAME_MODIFIER__ONE_VALUE, modifier: 'not', template: 'I.dontSee({{{value}}});' },
    // select
    { action: 'select', comp: CmdCmp.ONE_TARGET__ONE_VALUE, template: 'I.selectOption({{{target}}}, {{{value}}});' },
    // shake (Appium only)
    ...
    // uncheck
    { action: 'uncheck', comp: CmdCmp.ONE_VALUE__ONE_TARGET, template: 'I.uncheckOption({{{value}}}, {{{target}}});' },
    ...
    { action: 'uncheck', comp: CmdCmp.ONE_VALUE, template: 'I.uncheckOption({{{value}}});' },
    // wait + url
    { action: 'wait', comp: CmdCmp.SAME_TARGET_TYPE__ONE_VALUE, targetType: 'url', template: 'I.waitUrlEquals({{{value}}});' },
    { action: 'wait', comp: CmdCmp.SAME_TARGET_TYPE__ONE_VALUE_ONE_NUMBER, targetType: 'url', valuesAsNonArray: true, template: 'I.waitUrlEquals({{{value}}});' },
    ...
    { action: 'wait', comp: CmdCmp.SAME_OPTION__ONE_VALUE__ONE_NUMBER, options: [ 'visible' ], valuesAsNonArray: true, template: 'I.waitForVisible({{{value}}});' },
    { action: 'wait', comp: CmdCmp.SAME_OPTION__ONE_VALUE, options: [ 'visible' ], template: 'I.waitForVisible({{{value}}});' },
    // wait + invisible
    ...
    { action: 'wait', comp: CmdCmp.SAME_OPTION__ONE_VALUE__ONE_NUMBER, options: [ 'invisible' ], valuesAsNonArray: true, template: 'I.waitForInvisible({{{value}}});' },
    { action: 'wait', comp: CmdCmp.SAME_OPTION__ONE_VALUE, options: [ 'invisible' ], template: 'I.waitForInvisible({{{value}}});' },
    // wait + enabled
    ...
    { action: 'wait', comp: CmdCmp.SAME_OPTION__ONE_VALUE__ONE_NUMBER, options: [ 'enabled' ], valuesAsNonArray: true, template: 'I.waitForEnabled({{{value}}});' },
    { action: 'wait', comp: CmdCmp.SAME_OPTION__ONE_VALUE, options: [ 'enabled' ], template: 'I.waitForEnabled({{{value}}});' },
    // wait + ( hide | hidden )
    { action: 'wait', comp: CmdCmp.SAME_OPTION__ONE_TARGET__ONE_NUMBER, options: [ 'hide' ], template: 'I.waitToHide({{{target}}}, {{{value}}});' },
    { action: 'wait', comp: CmdCmp.SAME_OPTION__ONE_TARGET, options: [ 'hide' ], template: 'I.waitToHide({{{target}}});' },
    { action: 'wait', comp: CmdCmp.SAME_OPTION__ONE_VALUE__ONE_NUMBER, options: [ 'hide' ], valuesAsNonArray: true, template: 'I.waitToHide({{{value}}});' },
    { action: 'wait', comp: CmdCmp.SAME_OPTION__ONE_VALUE, options: [ 'hide' ], template: 'I.waitToHide({{{value}}});' },
    ...
    { action: 'wait', comp: CmdCmp.SAME_OPTION__ONE_VALUE__ONE_NUMBER, options: [ 'hidden' ], valuesAsNonArray: true, template: 'I.waitToHide({{{value}}});' },
    { action: 'wait', comp: CmdCmp.SAME_OPTION__ONE_VALUE, options: [ 'hidden' ], template: 'I.waitToHide({{{value}}});' },
    // wait + text
    ...
    { action: 'wait', comp: CmdCmp.SAME_OPTION__ONE_VALUE, options: [ 'text' ], template: 'I.waitForText({{{value}}});' },
    ...
    // wait + value
    { action: 'wait', comp: CmdCmp.SAME_OPTION__ONE_TARGET__ONE_VALUE__ONE_NUMBER, options: [ 'value' ], valuesAsNonArray: true, template: 'I.waitForValue({{{target}}}, {{{value}}});' },
    { action: 'wait', comp: CmdCmp.SAME_OPTION__ONE_TARGET__ONE_VALUE, options: [ 'value' ], template: 'I.waitForValue({{{target}}}, {{{value}}});' },
    // wait + target
    { action: 'wait', comp: CmdCmp.ONE_TARGET__ONE_NUMBER, template: 'I.waitForElement({{{target}}}, {{{value}}});' },
    { action: 'wait', comp: CmdCmp.ONE_TARGET, template: 'I.waitForElement({{{target}}});' },
    { action: 'wait', comp: CmdCmp.ONE_VALUE, template: 'I.waitForElement({{{value}}});' },
    { action: 'wait', comp: CmdCmp.ONE_VALUE__ONE_NUMBER, valuesAsNonArray: true, template: 'I.waitForElement({{{value}}});' },
    // wait

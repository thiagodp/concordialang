 ...
 */
export function fillWithZero( value: string, maxLength: number ) {
...
export function isValidDate( value: string ): boolean {
    ...
    const makeDateRegex = function( separator: string ): RegExp {
...
export function isShortTime( value: string ): boolean {
    if ( ! value ) {
        return false;
    }
...
export function isShortDateTime( value: string ): boolean {
    if ( ! value ) {
        return false;
    }
    const [ date, time ] = splitDateAndTime( value );
...
function splitDateAndTime( value: string ): [ string, string ] {

 ...
 */
export const DEFAULT_UI_PROPERTY_SYNTAX_RULE: SyntaxRule = UIP_RULES;
 ...
 * @author Thiago Delgado Pinto
 */
export const UI_PROPERTY_SYNTAX_RULES: Array< SyntaxRule > = [
    ...
    { name: UIPropertyTypes.EDITABLE,
        ...
        minTargets: 0 }, // target not required
